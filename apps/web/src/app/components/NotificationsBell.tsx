...
import { hospitalLabel, urgencyStyle, urgencyLabel, type BloodRequest, formatRelativeTime } from "@weare/core";
                ...
                >
                  ...
                  <span className="flex-1 min-w-0">
                    <span className="block text-[13px] font-bold truncate" style={{ color: "#0B2432" }}>
                      <BloodType value={r.bloodType} /> · {hospitalLabel(r.hospital, t)}
                    </span>
