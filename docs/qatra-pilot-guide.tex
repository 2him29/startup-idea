...
% ===========================================================================
\section{Who to ask, easiest first}
...
\midrule
1 & A university blood-donation club &
If you are a student this is the shortest distance. Clubs run drives with the
Croissant-Rouge already, the president has a group of donors on their phone,
and nobody has to ask a head office for permission. \\
2 & A local Croissant-Rouge committee &
Carries the most weight in front of a panel, because the name is the one the
whole argument rests on. Slower: somebody must be willing to say yes on the
organisation's behalf. \\
3 & Scouts or a mosque association &
Long histories with donation drives. Real lists, real trust, little
bureaucracy. \\
4 & A Facebook blood group &
...
\note{Start at the top of that list, not the bottom. A university club that says
yes this week is worth more than a wilaya committee that might say yes next
month — and the club is a reference when you go and ask the committee.}
...
approved it, and an introduction to the ANS is one of the two things being
asked for. Claiming an endorsement you do not have is the one mistake that
